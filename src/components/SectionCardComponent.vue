<template>
    <section class="card_shop bg-dark">
        <div class="container d-flex flex-wrap justify-content-center position-relative">
            <div class="current_series text-uppercase bg-primary p-2 position-absolute">
                current series
            </div>
            <!-- /.current_series -->
            <div class="row row-cols-6">
                <div class="cols" v-for="({thumb, series}, index) in cardShop" :key="index">
